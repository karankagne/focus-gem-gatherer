...
const Header = () => {
  ...
  return (
    <header className={`fixed w-full z-50 transition-all ${isHome ? 'py-4' : 'py-2'}`}>
      ...
      <AnimatePresence>
        {isMobile && isMenuOpen && (
          <motion.div
            ...
            className="fixed top-14 left-0 w-full bg-background/90 backdrop-blur-md border-b shadow-lg"
          >
